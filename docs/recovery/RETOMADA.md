...
- **Testes** — gdUnit4 6.2.1: 681 casos, 675 a passar, 6 saltados **com a razão escrita no próprio teste**,
...
| `data/i18n/strings.csv` | 329 chaves PT-PT e EN, zero por escrever. É o `strings.csv` único da §27. |
