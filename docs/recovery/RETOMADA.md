...
| v6 + F1 | 15/09/2026 | A Fase 1 inteira menos dois: **quinze dos dezassete** tickets, pela ordem do §66. As tropas em colunas, a moeda física, o minuto 0:20, o JobBoard, a muralha do §10 com os dois caminhos, o arqueiro e a certeza da torre, a Podridão e as criaturas nas três faixas, a economia e o *payback* do §06, a moral e a fuga, a luz por faixa, o save do estado da simulação, e a cena de jogo com os dois verbos ligados. Fecha com o **F1-15**: o cenário fechado do §07 em *headless*. Faltam o F1-16 e o F1-17, e os dois estão **bloqueados** — o F1-17 pelo ART-02, e o F1-16 pela Q-075: metade do critério do §66 mede-se e passa, e a outra metade não é afinável enquanto nada conseguir derrubar o núcleo. |
...
- **Testes** — gdUnit4 6.2.1: 335 casos, 325 a passar, 10 saltados **com a razão escrita no próprio teste**,
...
| O quê | Porquê |
|---|---|
| Jogabilidade | **Ninguém jogou** — com um teclado e olhos. O ciclo está todo lá e corre em *headless*: nove dos onze passos do `SimLoop` escritos (faltam o 9 e o 10, os dois da Fase 2), o mundo montado, a mancha a chegar ao crepúsculo, e a noite e a partida de dez dias medidas por instrumento (`noite_do_07_test.gd`, `dez_dias_test.gd`, `jogo_noite_test.gd`). E medir deu duas respostas que ninguém tinha: os números do §07 não batem (**Q-073**) e **o jogo não se pode perder** — só o `WallData` tem `contact_slots`, e uma obra com zero slots não recebe atacante nenhum, por isso nada consegue derrubar o castelo-árvore (**Q-075**). As duas estão escritas em vez de caladas, e é a segunda que bloqueia o F1-16. |
