...
- **Testes** — gdUnit4 6.2.1: 470 casos, 461 a passar, 9 saltados **com a razão escrita no próprio teste**,
...
| `docs/backlog/` | 72 tickets, um ficheiro cada, no formato da §34. |
