...
| v6 + jogo | 16/09/2026 | O *greybox* passa a jogar-se: a lei da travessia do §21 aplicada (a região atravessa-se em 48 s a pé e não em 148 — ADR 0021, Q-082), o preço do que está debaixo do rei em moedas por cima da coisa (§55, §24), e «largar em contínuo» do §24 ligado (Q-083). Três tickets: GB-04, GB-05 e GB-06. |
...
- **Testes** — gdUnit4 6.2.1: 390 casos, 381 a passar, 9 saltados **com a razão escrita no próprio teste**,
...
| `docs/adr/` | 21 decisões. A 0011 fecha a noite castanha; a 0012 a 0019 são a Parte XIII; a 0020 é a ordem do tick e a 0021 a lei da travessia do §21. |
| `docs/backlog/` | 56 tickets, um ficheiro cada, no formato da §34. |
