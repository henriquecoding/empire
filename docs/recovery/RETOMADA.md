...
- **Testes** — gdUnit4 6.2.1: 453 casos, 444 a passar, 9 saltados **com a razão escrita no próprio teste**,
...
| `docs/backlog/` | 68 tickets, um ficheiro cada, no formato da §34. |
