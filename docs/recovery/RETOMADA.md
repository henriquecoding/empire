...
- **Testes** — gdUnit4 6.2.1: 693 casos, 687 a passar, 6 saltados **com a razão escrita no próprio teste**,
...
| `data/i18n/strings.csv` | 337 chaves PT-PT e EN, zero por escrever. É o `strings.csv` único da §27. |
