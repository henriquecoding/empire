...
- **Testes** — gdUnit4 6.2.1: 493 casos, 484 a passar, 9 saltados **com a razão escrita no próprio teste**,
...
| `docs/backlog/` | 77 tickets, um ficheiro cada, no formato da §34. |
| `docs/content/` | Esquema, propostas, a Podridão dia a dia, os nomes. Tudo gerado. |
| `data/i18n/strings.csv` | 286 chaves PT-PT e EN, zero por escrever. É o `strings.csv` único da §27. |
