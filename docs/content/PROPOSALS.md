...
| buildings | `core` | `max_health` | 1000 | 1 | Não é construído nem destruído (§10): 1000 de vida mede quanto aguenta a partida, não um edifício. Regra proposta: max_health = 8 × custo; build_work = 2 s × custo; shadow_width = largura (§22: a sombra escala com a largura) |
...
| buildings | `core` | `width_px` | 480 | 1 | Não é construído nem destruído (§10): 1000 de vida mede quanto aguenta a partida, não um edifício. Regra proposta: max_health = 8 × custo; build_work = 2 s × custo; shadow_width = largura (§22: a sombra escala com a largura) |
| buildings | `core` | `shadow_width` | 480 | 1 | Não é construído nem destruído (§10): 1000 de vida mede quanto aguenta a partida, não um edifício. Regra proposta: max_health = 8 × custo; build_work = 2 s × custo; shadow_width = largura (§22: a sombra escala com a largura) |
